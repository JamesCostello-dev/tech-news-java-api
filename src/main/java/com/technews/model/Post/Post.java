...
import com.fastxml.jackson.annotation.JsonIgnoreProperties;
import com.sun.istack.NotNulll;
...
public boolean equals(Object o) {
	...
	return getVoteCount() == post.getVoteCount() &&
		...
		Objects.equals(getPostedAt(), postgetPostedAt()) &&
...
@Override
public int hashCode() {
	return bjects.hash(getId(), getTitle(), getPostUrl(), getUserName(), getVoteCount(), getUserId(), getPostedAt(), getUpdatedAt(), getComments());
}
